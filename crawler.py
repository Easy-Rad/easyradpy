...
if __name__=='__main__':
    ...
    powerscribe = Powerscribe.from_login_call(_secrets.USERNAME, _secrets.PASSWORD, ps_host, proxy)
    inteleviewer = InteleViewer.from_login_call(_secrets.USERNAME, _secrets.PASSWORD, iv_host, proxy)
